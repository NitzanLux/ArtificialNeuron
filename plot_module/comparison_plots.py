...
#data
x_scatter,y_scatter=np.where(np.random.randint(2, size=(100, 100)))
ax0_pos = fig.axes[0].get_position()
fig.axes[0].set_position([0.02,ax0_pos.y0,ax0_pos.width+ax0_pos.x0,ax0_pos.height])
ax0_pos = fig.axes[0].get_position()
...
fig.axes[1].set_position([ax1_pos.x0,ax1_pos.y0,ax1_pos.width,ax1_pos.height])
ax1_pos = fig.axes[1].get_position()
fig.axes[1].plot(np.arange(10))


ax2_pos = fig.axes[2].get_position()
fig.axes[2].set_position([ax2_pos.x0,ax1_pos.y0-ax2_pos.height*1.001,ax2_pos.width,ax2_pos.height])
ax2_pos = fig.axes[2].get_position()
fig.axes[2].plot(np.arange(10))

ax3_pos = fig.axes[3].get_position()
fig.axes[3].set_position([ax3_pos.x0,ax3_pos.y0,ax3_pos.width,ax3_pos.height])
fig.axes[3].plot(np.arange(100))

ax4_pos = fig.axes[4].get_position()
fig.axes[4].set_position([ax4_pos.x0,ax3_pos.y0-ax4_pos.height*1.001,ax4_pos.width,ax4_pos.height])
ax4_pos = fig.axes[4].get_position()
fig.axes[4].plot(np.arange(100))
# plt.tight_layout()
...
fig.axes[5].set_position([ax0_pos.x0+ax0_pos.width*1.1,ax2_pos.y0+(ax1_pos.height+ax2_pos.height)/2-ax5_pos.height/2,ax5_pos.width,ax5_pos.height])
...
fig.axes[6].set_position([ax0_pos.x0+ax0_pos.width*1.1,ax4_pos.y0+(ax3_pos.height+ax4_pos.height)/2-ax6_pos.height/2,ax6_pos.width,ax6_pos.height])
