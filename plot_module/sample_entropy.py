...
if __name__ == "__main__":
    ...
    for i in range(number_of_clusters):
        ...
        print(indexes)
        job_factory.send_job(f"sample_entropy_{i}_{MAX_INTERVAL}d", f'python -c "from plot_module.sample_entropy import get_sample_entropy; get_sample_entropy({indexes})"',mem=200000)
        print('job sent')