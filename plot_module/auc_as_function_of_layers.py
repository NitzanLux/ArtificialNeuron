...
plt.errorbar(layers_original, original_auc_plotting, yerr=original_auc_plotting_err,label='original')
plt.errorbar(layers_reduction, reduction_auc_plotting, yerr=reduction_auc_plotting_err,label='reduction')
plt.legend()
plt.show()
