...
a = job_factory.send_job('gt_%s'%args.gt_name,'python -c "from model_evaluation_multiple import create_gt_and_save;import os; print(os.getcwd()); create_gt_and_save(%s,%s)"'%("'"+args.gt_path+"'","'"+args.gt_name+"'"))
print(a)
