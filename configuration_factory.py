...
def surround_with_default_config_values(**kargs):
    ...
    config = AttrDict(config_version=CURRENT_VERSION, input_window_size=300, prediction_length=1, num_segments=2 * 639,
                      ...
                      lr_scheduler='ReduceLROnPlateau',lr_scheduler_params=dict(factor=0.5,cooldown=200, threshold=1e-5,patience =300,eps=8e-5),
                      # lr_scheduler=None,
...
if __name__ == '__main__':
    ...
    configurations_name = "mse_der_const"
    for i in ['AdamW']:
        config_morpho_0 = config_factory(loss_function='weighted_mse_loss_derivative',
                                         ...
                                         batch_size_validation=128, batch_size_train=8, clip_gradients_factor=1,
