...
def surround_with_default_config_values(**kargs):
    ...
    config = AttrDict(config_version=CURRENT_VERSION, input_window_size=300, prediction_length=1, num_segments=2 * 639,
                      ...
                      lr_scheduler='ReduceLROnPlateau',lr_scheduler_params=dict(factor=0.5,cooldown=30, patience =50,eps=7e-5),
                      # lr_scheduler=None,
...
def load_config_file(path: str) -> AttrDict:
    ...
    # config.accumulate_loss_batch_factor=5
