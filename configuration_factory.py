...
def surround_with_default_config_values(**kargs):
    ...
    config = AttrDict(config_version=CURRENT_VERSION, input_window_size=120, prediction_length=1, num_segments=2 * 639,
                      ...
                      optimizer_type="NAdam", optimizer_params=dict(weight_decay=1e-3),clip_gradients_factor=None,  # optimizer_params={'eps':1e-8},
...
if __name__ == '__main__':
    ...
    for i in ['NAdam']:
        config_morpho_0 = config_factory(
                                         ...
                                         accumulate_loss_batch_factor=1, prediction_length=3000,
