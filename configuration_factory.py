...
def config_factory(save_model_to_config_dir=True, config_new_path=None, generate_random_seeds=False, is_new_name=False,
    ...
    config = AttrDict(config_version=1.1,input_window_size=200, num_segments=2 * 639, num_syn_types=1,
                      ...
                      constant_loss_weights=[1., 1., 0., 0], constant_sigma=1.2, constant_learning_rate=0.0001,
...
if __name__ == '__main__':
    ...
    config_morpho_0 =config_factory(dynamic_learning_params=False, architecture_type="LAYERED_TEMPORAL_CONV",
                    model_tag="cm_hinge_model",skip_conections=True,
                         inter_module_skip_connections=True,batch_size_validation=200,spike_probability=0.5,clip_gradients_factor=1,constant_learning_rate=0.0007, loss_function="hinge_mse_dvt_loss")
    configs.append(config_morpho_0)

    with open(os.path.join(MODELS_DIR, "cm_overcheack_model_12.json"), 'w') as file:
