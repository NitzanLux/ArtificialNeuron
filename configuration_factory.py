...
def surround_with_default_config_values(**kargs):
    ...
    architecture_dict = AttrDict(#segment_tree_path="tree.pkl",
                                 ...
                                 kernel_size=49,
                                 kernel_size_intersection=11,
                                 kernel_size_branch=11,
                                 # kernel_size=81,
                                 # number_of_layers=2,
                                 stride=1,
                                 padding=0,
...
if __name__ == '__main__':
    ...
    configurations_name = "trimmed_kernel"
    for i in ['AdamW','NAdam']:
        config_morpho_0 = config_factory(loss_function='focalbcel_mse_mae_loss',
                                         ...
                                         batch_size_validation=200, batch_size_train=4, clip_gradients_factor=2.,
