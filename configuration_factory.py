...
if __name__ == '__main__':
    ...
    for i in ['AdamW']:
        config_morpho_0 = config_factory(loss_function='focalbcel_mse_loss',
                                         ...
                                         accumulate_loss_batch_factor=1, spike_probability=None, prediction_length=(6000-600)/10,
                                         batch_size_validation=64, batch_size_train=1, clip_gradients_factor=2.5,
