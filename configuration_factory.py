...
if __name__ == '__main__':
    ...
    configurations_name = "inter_4_1t"
    for i in ['AdamW']:
        config_morpho_0 = config_factory(loss_function='weighted_mse_loss_derivative',
                                         ...
                                         accumulate_loss_batch_factor=1, spike_probability=None, prediction_length=5780,
                                         batch_size_validation=64, batch_size_train=1, clip_gradients_factor=10,
