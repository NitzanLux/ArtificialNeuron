...
def surround_with_default_config_values(**kargs):
    ...
    architecture_dict = AttrDict(#segment_tree_path="tree.pkl",
                                 ...
                                 # kernel_size_2d=3,
                                 # kernel_size_1d=9,
                                 number_of_layers_root=4, number_of_layers_leaf=6, number_of_layers_intersection=4,
...
if __name__ == '__main__':
    ...
    for i in ['AdamW']:
        config_morpho_0 = config_factory(loss_function='weighted_mse_loss_derivative',
                                         ...
                                         accumulate_loss_batch_factor=16, spike_probability=None, prediction_length=5780,
                                         batch_size_validation=64, batch_size_train=2, clip_gradients_factor=1,
