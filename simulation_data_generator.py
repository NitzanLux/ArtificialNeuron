...
class SimulationDataGenerator():
    ...
    def __init__(self, sim_experiment_files, buffer_size_in_files=12, epoch_size=None,
                 batch_size=8, sample_ratio_to_shuffle=4, prediction_length=1, window_size_ms=300, DVT_PCA_model=None,
                 ignore_time_from_start=20, y_train_soma_bias=-67.7, y_soma_threshold=Y_SOMA_THRESHOLD, y_DTV_threshold=3.0,
