...
class BranchLeafBlock(nn.Module):
    def __init__(self, input_shape: Tuple[int, int], activation_function, channel_input_number
        ...
        self.conv1d_1_BranchLeafBlock = Conv1d(channel_input_number, inner_scope_channel_number,
                                               input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                               kernel_size, stride, padding, dilation)

        self.conv1d_2_BranchLeafBlock = Conv1d(inner_scope_channel_number, inner_scope_channel_number,
                                               input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                               kernel_size, stride, padding, dilation)
        ...
        self.net = nn.Sequential(self.conv1d_1_BranchLeafBlock, activation_function,
                                 self.conv1d_2_BranchLeafBlock, activation_function,
...
class BranchBlock(nn.Module):  # FIXME fix the channels and its movment in the branch block
    def __init__(self, input_shape: Tuple[int, int], activation_function, channel_input_number
        ...
        padding = keep_dimensions_by_padding_claculator((input_shape[0], input_shape[1] - NUMBER_OF_PREVIUSE_SEGMENTS_IN_BRANCH), kernel_size, stride, dilation,
                                                        SYNAPSE_DIMENTION_POSITION - 2)
        self.conv1d_1_BranchBlock = Conv1d(channel_output_number, inner_scope_channel_number,
                                                 input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                                 kernel_size, stride, padding, dilation)

        self.conv1d_2_BranchBlock = Conv1d(inner_scope_channel_number, inner_scope_channel_number,
                                                 input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                                 kernel_size, stride, padding, dilation)
...
class IntersectionBlock(nn.Module):
    def __init__(self, input_shape: Tuple[int, int], activation_function, channel_input_number
        ...
        padding = keep_dimensions_by_padding_claculator(input_shape, kernel_size, stride, dilation,
                                                        SYNAPSE_DIMENTION_POSITION - 2)
        self.conv1d_1_IntersectionBlock = Conv1d(channel_output_number, inner_scope_channel_number,
                                                 input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                                 kernel_size, stride, padding, dilation)

        self.conv1d_2_IntersectionBlock = Conv1d(inner_scope_channel_number, channel_output_number,
                                                 input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                                 kernel_size, stride, padding, dilation)
        ...
        self.net = nn.Sequential(self.conv1d_1_IntersectionBlock, activation_function, self.conv1d_2_IntersectionBlock,
...
class RootBlock(nn.Module):
    def __init__(self, input_shape: Tuple[int, int], activation_function, channel_input_number
        ...
        padding = keep_dimensions_by_padding_claculator(input_shape, kernel_size, stride, dilation,
                                                        SYNAPSE_DIMENTION_POSITION - 2)
        self.conv1d_root = Conv1d(channel_output_number, inner_scope_channel_number,
                                  input_shape[SYNAPSE_DIMENTION_POSITION - 2],
                                  kernel_size, stride, padding, dilation)
