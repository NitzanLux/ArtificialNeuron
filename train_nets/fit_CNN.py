...
VALIDATION_EVALUATION_FREQUENCY = 5
ACCURACY_EVALUATION_FREQUENCY = 20
BATCH_LOG_UPDATE_FREQ = 100
BUFFER_SIZE_IN_FILES_VALID = 100
# BUFFER_SIZE_IN_FILES_VALID = 2 if USE_CUDA else 2
BUFFER_SIZE_IN_FILES_TRAINING = 200
